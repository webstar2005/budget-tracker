 ...
 */var M_;function WS(){if(M_)return bt;M_=1;var r=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),n=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),o=Symbol.for("react.profiler"),u=Symbol.for("react.consumer"),f=Symbol.for("react.context"),m=Symbol.for("react.forward_ref"),p=Symbol.for("react.suspense"),y=Symbol.for("react.memo"),T=Symbol.for("react.lazy"),b=Symbol.iterator;function R(D){return D===null||typeof D!="object"?null:(D=b&&D[b]||D["@@iterator"],typeof D=="function"?D:null)}var L={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},$=Object.assign,J={};function W(D,Z,it){this.props=D,this.context=Z,this.refs=J,this.updater=it||L}W.prototype.isReactComponent={},W.prototype.setState=function(D,Z){if(typeof D!="object"&&typeof D!="function"&&D!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,D,Z,"setState")},W.prototype.forceUpdate=function(D){this.updater.enqueueForceUpdate(this,D,"forceUpdate")};function Et(){}Et.prototype=W.prototype;function ct(D,Z,it){this.props=D,this.context=Z,this.refs=J,this.updater=it||L}var ht=ct.prototype=new Et;ht.constructor=ct,$(ht,W.prototype),ht.isPureReactComponent=!0;var Mt=Array.isArray,Tt={H:null,A:null,T:null,S:null,V:null},Pt=Object.prototype.hasOwnProperty;function V(D,Z,it,tt,ft,It){return it=It.ref,{$$typeof:r,type:D,key:Z,ref:it!==void 0?it:null,props:It}}function S(D,Z){return V(D.type,Z,void 0,void 0,void 0,D.props)}function I(D){return typeof D=="object"&&D!==null&&D.$$typeof===r}function N(D){var Z={"=":"=0",":":"=2"};return"$"+D.replace(/[=:]/g,function(it){return Z[it]})}var M=/\/+/g;function k(D,Z){return typeof D=="object"&&D!==null&&D.key!=null?N(""+D.key):Z.toString(36)}function C(){}function xe(D){switch(D.status){case"fulfilled":return D.value;case"rejected":throw D.reason;default:switch(typeof D.status=="string"?D.then(C,C):(D.status="pending",D.then(function(Z){D.status==="pending"&&(D.status="fulfilled",D.value=Z)},function(Z){D.status==="pending"&&(D.status="rejected",D.reason=Z)})),D.status){case"fulfilled":return D.value;case"rejected":throw D.reason}}throw D}function ae(D,Z,it,tt,ft){var It=typeof D;(It==="undefined"||It==="boolean")&&(D=null);var vt=!1;if(D===null)vt=!0;else switch(It){case"bigint":case"string":case"number":vt=!0;break;case"object":switch(D.$$typeof){case r:case t:vt=!0;break;case T:return vt=D._init,ae(vt(D._payload),Z,it,tt,ft)}}if(vt)return ft=ft(D),vt=tt===""?"."+k(D,0):tt,Mt(ft)?(it="",vt!=null&&(it=vt.replace(M,"$&/")+"/"),ae(ft,Z,it,"",function(Yn){return Yn})):ft!=null&&(I(ft)&&(ft=S(ft,it+(ft.key==null||D&&D.key===ft.key?"":(""+ft.key).replace(M,"$&/")+"/")+vt)),Z.push(ft)),1;vt=0;var Ce=tt===""?".":tt+":";if(Mt(D))for(var Zt=0;Zt<D.length;Zt++)tt=D[Zt],It=Ce+k(tt,Zt),vt+=ae(tt,Z,it,It,ft);else if(Zt=R(D),typeof Zt=="function")for(D=Zt.call(D),Zt=0;!(tt=D.next()).done;)tt=tt.value,It=Ce+k(tt,Zt++),vt+=ae(tt,Z,it,It,ft);else if(It==="object"){if(typeof D.then=="function")return ae(xe(D),Z,it,tt,ft);throw Z=String(D),Error("Objects are not valid as a React child (found: "+(Z==="[object Object]"?"object with keys {"+Object.keys(D).join(", ")+"}":Z)+"). If you meant to render a collection of children, use an array instead.")}return vt}function F(D,Z,it){if(D==null)return D;var tt=[],ft=0;return ae(D,tt,"","",function(It){return Z.call(it,It,ft++)}),tt}function nt(D){if(D._status===-1){var Z=D._result;Z=Z(),Z.then(function(it){(D._status===0||D._status===-1)&&(D._status=1,D._result=it)},function(it){(D._status===0||D._status===-1)&&(D._status=2,D._result=it)}),D._status===-1&&(D._status=0,D._result=Z)}if(D._status===1)return D._result.default;throw D._result}var lt=typeof reportError=="function"?reportError:function(D){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var Z=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof D=="object"&&D!==null&&typeof D.message=="string"?String(D.message):String(D),error:D});if(!window.dispatchEvent(Z))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",D);return}console.error(D)};function Bt(){}return bt.Children={map:F,forEach:function(D,Z,it){F(D,function(){Z.apply(this,arguments)},it)},count:function(D){var Z=0;return F(D,function(){Z++}),Z},toArray:function(D){return F(D,function(Z){return Z})||[]},only:function(D){if(!I(D))throw Error("React.Children.only expected to receive a single React element child.");return D}},bt.Component=W,bt.Fragment=n,bt.Profiler=o,bt.PureComponent=ct,bt.StrictMode=s,bt.Suspense=p,bt.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=Tt,bt.__COMPILER_RUNTIME={__proto__:null,c:function(D){return Tt.H.useMemoCache(D)}},bt.cache=function(D){return function(){return D.apply(null,arguments)}},bt.cloneElement=function(D,Z,it){if(D==null)throw Error("The argument must be a React element, but you passed "+D+".");var tt=$({},D.props),ft=D.key,It=void 0;if(Z!=null)for(vt in Z.ref!==void 0&&(It=void 0),Z.key!==void 0&&(ft=""+Z.key),Z)!Pt.call(Z,vt)||vt==="key"||vt==="__self"||vt==="__source"||vt==="ref"&&Z.ref===void 0||(tt[vt]=Z[vt]);var vt=arguments.length-2;if(vt===1)tt.children=it;else if(1<vt){for(var Ce=Array(vt),Zt=0;Zt<vt;Zt++)Ce[Zt]=arguments[Zt+2];tt.children=Ce}return V(D.type,ft,void 0,void 0,It,tt)},bt.createContext=function(D){return D={$$typeof:f,_currentValue:D,_currentValue2:D,_threadCount:0,Provider:null,Consumer:null},D.Provider=D,D.Consumer={$$typeof:u,_context:D},D},bt.createElement=function(D,Z,it){var tt,ft={},It=null;if(Z!=null)for(tt in Z.key!==void 0&&(It=""+Z.key),Z)Pt.call(Z,tt)&&tt!=="key"&&tt!=="__self"&&tt!=="__source"&&(ft[tt]=Z[tt]);var vt=arguments.length-2;if(vt===1)ft.children=it;else if(1<vt){for(var Ce=Array(vt),Zt=0;Zt<vt;Zt++)Ce[Zt]=arguments[Zt+2];ft.children=Ce}if(D&&D.defaultProps)for(tt in vt=D.defaultProps,vt)ft[tt]===void 0&&(ft[tt]=vt[tt]);return V(D,It,void 0,void 0,null,ft)},bt.createRef=function(){return{current:null}},bt.forwardRef=function(D){return{$$typeof:m,render:D}},bt.isValidElement=I,bt.lazy=function(D){return{$$typeof:T,_payload:{_status:-1,_result:D},_init:nt}},bt.memo=function(D,Z){return{$$typeof:y,type:D,compare:Z===void 0?null:Z}},bt.startTransition=function(D){var Z=Tt.T,it={};Tt.T=it;try{var tt=D(),ft=Tt.S;ft!==null&&ft(it,tt),typeof tt=="object"&&tt!==null&&typeof tt.then=="function"&&tt.then(Bt,lt)}catch(It){lt(It)}finally{Tt.T=Z}},bt.unstable_useCacheRefresh=function(){return Tt.H.useCacheRefresh()},bt.use=function(D){return Tt.H.use(D)},bt.useActionState=function(D,Z,it){return Tt.H.useActionState(D,Z,it)},bt.useCallback=function(D,Z){return Tt.H.useCallback(D,Z)},bt.useContext=function(D){return Tt.H.useContext(D)},bt.useDebugValue=function(){},bt.useDeferredValue=function(D,Z){return Tt.H.useDeferredValue(D,Z)},bt.useEffect=function(D,Z,it){var tt=Tt.H;if(typeof it=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return tt.useEffect(D,Z)},bt.useId=function(){return Tt.H.useId()},bt.useImperativeHandle=function(D,Z,it){return Tt.H.useImperativeHandle(D,Z,it)},bt.useInsertionEffect=function(D,Z){return Tt.H.useInsertionEffect(D,Z)},bt.useLayoutEffect=function(D,Z){return Tt.H.useLayoutEffect(D,Z)},bt.useMemo=function(D,Z){return Tt.H.useMemo(D,Z)},bt.useOptimistic=function(D,Z){return Tt.H.useOptimistic(D,Z)},bt.useReducer=function(D,Z,it){return Tt.H.useReducer(D,Z,it)},bt.useRef=function(D){return Tt.H.useRef(D)},bt.useState=function(D){return Tt.H.useState(D)},bt.useSyncExternalStore=function(D,Z,it){return Tt.H.useSyncExternalStore(D,Z,it)},bt.useTransition=function(){return Tt.H.useTransition()},bt.version="19.1.0",bt}var P_;function Im(){return P_||(P_=1,Pd.exports=WS()),Pd.exports}var ve=Im();const z=$S(ve);var kd={exports:{}},Tl={},xd={exports:{}},Ld={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var k_;function ZS(){return k_||(k_=1,function(r){function t(F,nt){var lt=F.length;F.push(nt);t:for(;0<lt;){var Bt=lt-1>>>1,D=F[Bt];if(0<o(D,nt))F[Bt]=nt,F[lt]=D,lt=Bt;else break t}}function n(F){return F.length===0?null:F[0]}function s(F){if(F.length===0)return null;var nt=F[0],lt=F.pop();if(lt!==nt){F[0]=lt;t:for(var Bt=0,D=F.length,Z=D>>>1;Bt<Z;){var it=2*(Bt+1)-1,tt=F[it],ft=it+1,It=F[ft];if(0>o(tt,lt))ft<D&&0>o(It,tt)?(F[Bt]=It,F[ft]=lt,Bt=ft):(F[Bt]=tt,F[it]=lt,Bt=it);else if(ft<D&&0>o(It,lt))F[Bt]=It,F[ft]=lt,Bt=ft;else break t}}return nt}function o(F,nt){var lt=F.sortIndex-nt.sortIndex;return lt!==0?lt:F.id-nt.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var u=performance;r.unstable_now=function(){return u.now()}}else{var f=Date,m=f.now();r.unstable_now=function(){return f.now()-m}}var p=[],y=[],T=1,b=null,R=3,L=!1,$=!1,J=!1,W=!1,Et=typeof setTimeout=="function"?setTimeout:null,ct=typeof clearTimeout=="function"?clearTimeout:null,ht=typeof setImmediate<"u"?setImmediate:null;function Mt(F){for(var nt=n(y);nt!==null;){if(nt.callback===null)s(y);else if(nt.startTime<=F)s(y),nt.sortIndex=nt.expirationTime,t(p,nt);else break;nt=n(y)}}function Tt(F){if(J=!1,Mt(F),!$)if(n(p)!==null)$=!0,Pt||(Pt=!0,k());else{var nt=n(y);nt!==null&&ae(Tt,nt.startTime-F)}}var Pt=!1,V=-1,S=5,I=-1;function N(){return W?!0:!(r.unstable_now()-I<S)}function M(){if(W=!1,Pt){var F=r.unstable_now();I=F;var nt=!0;try{t:{$=!1,J&&(J=!1,ct(V),V=-1),L=!0;var lt=R;try{e:{for(Mt(F),b=n(p);b!==null&&!(b.expirationTime>F&&N());){var Bt=b.callback;if(typeof Bt=="function"){b.callback=null,R=b.priorityLevel;var D=Bt(b.expirationTime<=F);if(F=r.unstable_now(),typeof D=="function"){b.callback=D,Mt(F),nt=!0;break e}b===n(p)&&s(p),Mt(F)}else s(p);b=n(p)}if(b!==null)nt=!0;else{var Z=n(y);Z!==null&&ae(Tt,Z.startTime-F),nt=!1}}break t}finally{b=null,R=lt,L=!1}nt=void 0}}finally{nt?k():Pt=!1}}}var k;if(typeof ht=="function")k=function(){ht(M)};else if(typeof MessageChannel<"u"){var C=new MessageChannel,xe=C.port2;C.port1.onmessage=M,k=function(){xe.postMessage(null)}}else k=function(){Et(M,0)};function ae(F,nt){V=Et(function(){F(r.unstable_now())},nt)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(F){F.callback=null},r.unstable_forceFrameRate=function(F){0>F||125<F?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):S=0<F?Math.floor(1e3/F):5},r.unstable_getCurrentPriorityLevel=function(){return R},r.unstable_next=function(F){switch(R){case 1:case 2:case 3:var nt=3;break;default:nt=R}var lt=R;R=nt;try{return F()}finally{R=lt}},r.unstable_requestPaint=function(){W=!0},r.unstable_runWithPriority=function(F,nt){switch(F){case 1:case 2:case 3:case 4:case 5:break;default:F=3}var lt=R;R=F;try{return nt()}finally{R=lt}},r.unstable_scheduleCallback=function(F,nt,lt){var Bt=r.unstable_now();switch(typeof lt=="object"&&lt!==null?(lt=lt.delay,lt=typeof lt=="number"&&0<lt?Bt+lt:Bt):lt=Bt,F){case 1:var D=-1;break;case 2:D=250;break;case 5:D=1073741823;break;case 4:D=1e4;break;default:D=5e3}return D=lt+D,F={id:T++,callback:nt,priorityLevel:F,startTime:lt,expirationTime:D,sortIndex:-1},lt>Bt?(F.sortIndex=lt,t(y,F),n(p)===null&&F===n(y)&&(J?(ct(V),V=-1):J=!0,ae(Tt,lt-Bt))):(F.sortIndex=D,t(p,F),$||L||($=!0,Pt||(Pt=!0,k()))),F},r.unstable_shouldYield=N,r.unstable_wrapCallback=function(F){var nt=R;return function(){var lt=R;R=nt;try{return F.apply(this,arguments)}finally{R=lt}}}}(Ld)),Ld}var x_;function JS(){return x_||(x_=1,xd.exports=ZS()),xd.exports}var Ud={exports:{}},Ye={};/**
 * @license React
...
</defs>`,$.innerText="Preview backend running in this workspace."),$.setAttribute("id",L)}document.readyState==="loading"?window.addEventListener("DOMContentLoaded",b):b()}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fc=new hh("@firebase/auth");function $w(r,...t){Fc.logLevel<=Nt.WARN&&Fc.warn(`Auth (${so}): ${r}`,...t)}function Vc(r,...t){Fc.logLevel<=Nt.ERROR&&Fc.error(`Auth (${so}): ${r}`,...t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bs=new hh("@firebase/firestore");function ja(){return Bs.logLevel}function st(r,...t){if(Bs.logLevel<=Nt.DEBUG){const n=t.map(Fm);Bs.debug(`Firestore (${oo}): ${r}`,...n)}}function Zi(r,...t){if(Bs.logLevel<=Nt.ERROR){const n=t.map(Fm);Bs.error(`Firestore (${oo}): ${r}`,...n)}}function qr(r,...t){if(Bs.logLevel<=Nt.WARN){const n=t.map(Fm);Bs.warn(`Firestore (${oo}): ${r}`,...n)}}function Fm(r){if(typeof r=="string")return r;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class eh{constructor(t,n){this.position=t,this.inclusive=n}}function Fv(r,t,n){let s=0;for(let o=0;o<r.position.length;o++){const u=t[o],f=r.position[o];if(u.field.isKeyField()?s=ut.comparator(ut.fromName(f.referenceValue),n.key):s=to(f,n.data.field(u.field)),u.dir==="desc"&&(s*=-1),s!==0)break}return s}function Gv(r,t){if(r===null)return t===null;if(t===null||r.inclusive!==t.inclusive||r.position.length!==t.position.length)return!1;for(let n=0;n<r.position.length;n++)if(!Ei(r.position[n],t.position[n]))return!1;return!0}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const g2=new se(ut.comparator);function Ji(){return g2}const ST=new se(ut.comparator);function wl(...r){let t=ST;for(const n of r)t=t.insert(n.key,n);return t}function bT(r){let t=ST;return r.forEach((n,s)=>t=t.insert(n,s.overlayedDocument)),t}function ks(){return Vl()}function wT(){return Vl()}function Vl(){return new Ks(r=>r.toString(),(r,t)=>r.isEqual(t))}const p2=new se(ut.comparator),y2=new Ie(ut.comparator);function Vt(...r){let t=y2;for(const n of r)t=t.add(n);return t}const _2=new Ie(Rt);function v2(){return _2}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wh{constructor(t,n,s,o,u){this.snapshotVersion=t,this.targetChanges=n,this.targetMismatches=s,this.documentUpdates=o,this.resolvedLimboDocuments=u}static createSynthesizedRemoteEventForCurrentChange(t,n,s){const o=new Map;return o.set(t,Zl.createSynthesizedTargetChangeForCurrentChange(t,n,s)),new wh(At.min(),o,new se(Rt),Ji(),Vt())}}class Zl{constructor(t,n,s,o,u){this.resumeToken=t,this.current=n,this.addedDocuments=s,this.modifiedDocuments=o,this.removedDocuments=u}static createSynthesizedTargetChangeForCurrentChange(t,n,s){return new Zl(s,n,Vt(),Vt(),Vt())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class cD{constructor(){this.overlays=new se(ut.comparator),this.kr=new Map}getOverlay(t,n){return X.resolve(this.overlays.get(n))}getOverlays(t,n){const s=ks();return X.forEach(n,o=>this.getOverlay(t,o).next(u=>{u!==null&&s.set(o,u)})).next(()=>s)}saveOverlays(t,n,s){return s.forEach((o,u)=>{this.wt(t,n,u)}),X.resolve()}removeOverlaysForBatchId(t,n,s){const o=this.kr.get(s);return o!==void 0&&(o.forEach(u=>this.overlays=this.overlays.remove(u)),this.kr.delete(s)),X.resolve()}getOverlaysForCollection(t,n,s){const o=ks(),u=n.length+1,f=new ut(n.child("")),m=this.overlays.getIteratorFrom(f);for(;m.hasNext();){const p=m.getNext().value,y=p.getKey();if(!n.isPrefixOf(y.path))break;y.path.length===u&&p.largestBatchId>s&&o.set(p.getKey(),p)}return X.resolve(o)}getOverlaysForCollectionGroup(t,n,s,o){let u=new se((y,T)=>y-T);const f=this.overlays.getIterator();for(;f.hasNext();){const y=f.getNext().value;if(y.getKey().getCollectionGroup()===n&&y.largestBatchId>s){let T=u.get(y.largestBatchId);T===null&&(T=ks(),u=u.insert(y.largestBatchId,T)),T.set(y.getKey(),y)}}const m=ks(),p=u.getIterator();for(;p.hasNext()&&(p.getNext().value.forEach((y,T)=>m.set(y,T)),!(m.size()>=o)););return X.resolve(m)}wt(t,n,s){const o=this.overlays.get(s.key);if(o!==null){const f=this.kr.get(o.largestBatchId).delete(s.key);this.kr.set(o.largestBatchId,f)}this.overlays=this.overlays.insert(s.key,new D2(n,s));let u=this.kr.get(n);u===void 0&&(u=Vt(),this.kr.set(n,u)),this.kr.set(n,u.add(s.key))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rg{constructor(t,n,s,o){this.targetId=t,this.fromCache=n,this.Is=s,this.ds=o}static Es(t,n){let s=Vt(),o=Vt();for(const u of n.docChanges)switch(u.type){case 0:s=s.add(u.doc.key);break;case 1:o=o.add(u.doc.key)}return new rg(t,n.fromCache,s,o)}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _D{constructor(){this.As=!1,this.Rs=!1,this.Vs=100,this.fs=function(){return Db()?8:KC(Ze())>0?6:4}()}initialize(t,n){this.gs=t,this.indexManager=n,this.As=!0}getDocumentsMatchingQuery(t,n,s,o){const u={result:null};return this.ps(t,n).next(f=>{u.result=f}).next(()=>{if(!u.result)return this.ys(t,n,o,s).next(f=>{u.result=f})}).next(()=>{if(u.result)return;const f=new yD;return this.ws(t,n,f).next(m=>{if(u.result=m,this.Rs)return this.Ss(t,n,f,m.size)})}).next(()=>u.result)}Ss(t,n,s,o){return s.documentReadCount<this.Vs?(ja()<=Nt.DEBUG&&st("QueryEngine","SDK will not create cache indexes for query:",Ha(n),"since it only creates cache indexes for collection contains","more than or equal to",this.Vs,"documents"),X.resolve()):(ja()<=Nt.DEBUG&&st("QueryEngine","Query:",Ha(n),"scans",s.documentReadCount,"local documents and returns",o,"documents as results."),s.documentReadCount>this.fs*o?(ja()<=Nt.DEBUG&&st("QueryEngine","The SDK decides to create cache indexes for query:",Ha(n),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(t,mi(n))):X.resolve())}ps(t,n){if(Qv(n))return X.resolve(null);let s=mi(n);return this.indexManager.getIndexType(t,s).next(o=>o===0?null:(n.limit!==null&&o===1&&(n=ym(n,null,"F"),s=mi(n)),this.indexManager.getDocumentsMatchingTarget(t,s).next(u=>{const f=Vt(...u);return this.gs.getDocuments(t,f).next(m=>this.indexManager.getMinOffset(t,s).next(p=>{const y=this.bs(n,m);return this.Ds(n,y,f,p.readTime)?this.ps(t,ym(n,null,"F")):this.vs(t,y,n,p)}))})))}ys(t,n,s,o){return Qv(n)||o.isEqual(At.min())?X.resolve(null):this.gs.getDocuments(t,s).next(u=>{const f=this.bs(n,u);return this.Ds(n,f,s,o)?X.resolve(null):(ja()<=Nt.DEBUG&&st("QueryEngine","Re-using previous result from %s to execute query: %s",o.toString(),Ha(n)),this.vs(t,f,n,qC(o,Ul)).next(m=>m))})}bs(t,n){let s=new Ie(AT(t));return n.forEach((o,u)=>{Ah(t,u)&&(s=s.add(u))}),s}Ds(t,n,s,o){if(t.limit===null)return!1;if(s.size!==n.size)return!0;const u=t.limitType==="F"?n.last():n.first();return!!u&&(u.hasPendingWrites||u.version.compareTo(o)>0)}ws(t,n,s){return ja()<=Nt.DEBUG&&st("QueryEngine","Using full collection scan to execute query:",Ha(n)),this.gs.getDocumentsMatchingQuery(t,n,jr.min(),s)}vs(t,n,s,o){return this.gs.getDocumentsMatchingQuery(t,s,o).next(u=>(n.forEach(f=>{u=u.insert(f.key,f)}),u))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xe="WebChannelConnection";class MD extends ND{constructor(t){super(t),this.u_=[],this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams,this.longPollingOptions=t.longPollingOptions}jo(t,n,s,o,u){const f=Sm();return new Promise((m,p)=>{const y=new Q0;y.setWithCredentials(!0),y.listenOnce(Y0.COMPLETE,()=>{try{switch(y.getLastErrorCode()){case xc.NO_ERROR:const b=y.getResponseJson();st(Xe,`XHR for RPC '${t}' ${f} received:`,JSON.stringify(b)),m(b);break;case xc.TIMEOUT:st(Xe,`RPC '${t}' ${f} timed out`),p(new rt(Q.DEADLINE_EXCEEDED,"Request time out"));break;case xc.HTTP_ERROR:const R=y.getStatus();if(st(Xe,`RPC '${t}' ${f} failed with status:`,R,"response text:",y.getResponseText()),R>0){let L=y.getResponseJson();Array.isArray(L)&&(L=L[0]);const $=L?.error;if($&&$.status&&$.message){const J=function(Et){const ct=Et.toLowerCase().replace(/_/g,"-");return Object.values(Q).indexOf(ct)>=0?ct:Q.UNKNOWN}($.status);p(new rt(J,$.message))}else p(new rt(Q.UNKNOWN,"Server responded with status "+y.getStatus()))}else p(new rt(Q.UNAVAILABLE,"Connection failed."));break;default:yt(9055,{c_:t,streamId:f,l_:y.getLastErrorCode(),h_:y.getLastError()})}}finally{st(Xe,`RPC '${t}' ${f} completed.`)}});const T=JSON.stringify(o);st(Xe,`RPC '${t}' ${f} sending request:`,o),y.send(n,"POST",T,s,15)})}P_(t,n,s){const o=Sm(),u=[this.$o,"/","google.firestore.v1.Firestore","/",t,"/channel"],f=W0(),m=$0(),p={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},y=this.longPollingOptions.timeoutSeconds;y!==void 0&&(p.longPollingTimeout=Math.round(1e3*y)),this.useFetchStreams&&(p.useFetchStreams=!0),this.zo(p.initMessageHeaders,n,s),p.encodeInitMessageHeaders=!0;const T=u.join("");st(Xe,`Creating RPC '${t}' stream ${o}: ${T}`,p);const b=f.createWebChannel(T,p);this.T_(b);let R=!1,L=!1;const $=new VD({Ho:W=>{L?st(Xe,`Not sending because RPC '${t}' stream ${o} is closed:`,W):(R||(st(Xe,`Opening RPC '${t}' stream ${o} transport.`),b.open(),R=!0),st(Xe,`RPC '${t}' stream ${o} sending:`,W),b.send(W))},Yo:()=>b.close()}),J=(W,Et,ct)=>{W.listen(Et,ht=>{try{ct(ht)}catch(Mt){setTimeout(()=>{throw Mt},0)}})};return J(b,bl.EventType.OPEN,()=>{L||(st(Xe,`RPC '${t}' stream ${o} transport opened.`),$.s_())}),J(b,bl.EventType.CLOSE,()=>{L||(L=!0,st(Xe,`RPC '${t}' stream ${o} transport closed`),$.__(),this.I_(b))}),J(b,bl.EventType.ERROR,W=>{L||(L=!0,qr(Xe,`RPC '${t}' stream ${o} transport errored. Name:`,W.name,"Message:",W.message),$.__(new rt(Q.UNAVAILABLE,"The operation could not be completed")))}),J(b,bl.EventType.MESSAGE,W=>{var Et;if(!L){const ct=W.data[0];Ht(!!ct,16349);const ht=ct,Mt=ht?.error||((Et=ht[0])===null||Et===void 0?void 0:Et.error);if(Mt){st(Xe,`RPC '${t}' stream ${o} received error:`,Mt);const Tt=Mt.status;let Pt=function(I){const N=_e[I];if(N!==void 0)return MT(N)}(Tt),V=Mt.message;Pt===void 0&&(Pt=Q.INTERNAL,V="Unknown error status: "+Tt+" with message "+Mt.message),L=!0,$.__(new rt(Pt,V)),b.close()}else st(Xe,`RPC '${t}' stream ${o} received:`,ct),$.a_(ct)}}),J(m,X0.STAT_EVENT,W=>{W.stat===cm.PROXY?st(Xe,`RPC '${t}' stream ${o} detected buffering proxy`):W.stat===cm.NOPROXY&&st(Xe,`RPC '${t}' stream ${o} detected no buffering proxy`)}),setTimeout(()=>{$.o_()},0),$}terminate(){this.u_.forEach(t=>t.close()),this.u_=[]}T_(t){this.u_.push(t)}I_(t){this.u_=this.u_.filter(n=>n===t)}}function Zd(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $a{static emptySet(t){return new $a(t.comparator)}constructor(t){this.comparator=t?(n,s)=>t(n,s)||ut.comparator(n.key,s.key):(n,s)=>ut.comparator(n.key,s.key),this.keyedMap=wl(),this.sortedSet=new se(this.comparator)}has(t){return this.keyedMap.get(t)!=null}get(t){return this.keyedMap.get(t)}first(){return this.sortedSet.minKey()}last(){return this.sortedSet.maxKey()}isEmpty(){return this.sortedSet.isEmpty()}indexOf(t){const n=this.keyedMap.get(t);return n?this.sortedSet.indexOf(n):-1}get size(){return this.sortedSet.size}forEach(t){this.sortedSet.inorderTraversal((n,s)=>(t(n),!1))}add(t){const n=this.delete(t.key);return n.copy(n.keyedMap.insert(t.key,t),n.sortedSet.insert(t,null))}delete(t){const n=this.get(t);return n?this.copy(this.keyedMap.remove(t),this.sortedSet.remove(n)):this}isEqual(t){if(!(t instanceof $a)||this.size!==t.size)return!1;const n=this.sortedSet.getIterator(),s=t.sortedSet.getIterator();for(;n.hasNext();){const o=n.getNext().key,u=s.getNext().key;if(!o.isEqual(u))return!1}return!0}toString(){const t=[];return this.forEach(n=>{t.push(n.toString())}),t.length===0?"DocumentSet ()":`DocumentSet (
  `+t.join(`  
`)+`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yi{constructor(t,n){if(!isFinite(t)||t<-90||t>90)throw new rt(Q.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+t);if(!isFinite(n)||n<-180||n>180)throw new rt(Q.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+n);this._lat=t,this._long=n}get latitude(){return this._lat}get longitude(){return this._long}isEqual(t){return this._lat===t._lat&&this._long===t._long}_compareTo(t){return Rt(this._lat,t._lat)||Rt(this._long,t._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:yi._jsonSchemaVersion}}static fromJSON(t){if($l(t,yi._jsonSchema))return new yi(t.latitude,t.longitude)}}yi._jsonSchemaVersion="firestore/geoPoint/1.0",yi._jsonSchema={type:Te("string",yi._jsonSchemaVersion),latitude:Te("number"),longitude:Te("number")};/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
